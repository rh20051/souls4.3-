...
@onready var itemDisplayPoint = get_parent().get_parent().get_node("itemDisplay/SubViewportContainer/SubViewport/itemPoint")
@onready var itemDisplay = get_parent().get_parent().get_node("itemDisplay")
...
@onready var equipButtons = $VBoxContainer
